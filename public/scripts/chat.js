...
(function () {
  ...
  if (room) {
    ...
    sessionStorage.nameRoom = room
      .replace("_" + sessionStorage.roomId, "")
      .replace("%20g", " ")
      .toUpperCase();
  ...
  picker.on("emoji", function (emoji) {
    ...
    input.value += emoji
      .replace('<img class="emoji" draggable="false" alt="', "")
      .replace(valor, "")
      .replace('" src', "");
  });
...
>>>>>>> 81b81ef78abbdc82a08d52f8c669bda87fb74beb
  ...
  $(".colorblue,.colorgreen,.colorpurple,.colorceleste,.colornaranja").click(
    function () {
  ...
  $(
    ".colorblue,.colorgreen,.colorpurple,.colorceleste,.colornaranja"
  ).mouseenter(function () {
    $(this).css("border", "3.5px solid rgb(10, 10, 10)");
  });
  $(".colorblue,.colorgreen,.colorpurple,.colorceleste,.colornaranja").mouseout(
    function () {
...
>>>>>>> 81b81ef78abbdc82a08d52f8c669bda87fb74beb
  ...
  $("#copiarurl").click(function () {
    ...
    try {
      ...
      $(this).html(
        `<strong>Copiado con exito! </strong><i class="fas fa-check"></i>`
      );
...
alert("aea");
            ...
            if ($(".toast")[0]) {
              if (
                !$(".toast")
                  .html()
                  .includes(
                    `<strong>${replaceuser2}</strong> ha abandonado el chat.`
                  )
              ) {
                Command: toastr["info"](
                  `&nbsp;<strong>${userlast.toUpperCase()}</strong> ha abandonado el chat.`
                );
  ...
  $(".chat-history").on("scroll", function () {
    ...
    if (
      chatarea.offsetHeight + chatarea.scrollTop == chatarea.scrollHeight + 2 ||
    ...
    $(".scrolldown").css(
      "bottom",
      "-" + parseInt($(".chat-history").scrollTop() - 10) + "px"
    );
    setTimeout(function () {
    ...
    $(".mensajesnuevos").css(
      "bottom",
      "-" + parseInt($(".chat-history").scrollTop() - 35) + "px"
    );
    setTimeout(function () {
...
top.location.href = document.location.href ="index.html";
  ...
  color: #fff;`
          ...
          $("#message-to-send,#txtDestinomail,#txtNommail,#txtMessagemail").css(
            "background",
            "#155483"
          );
          ...
          $("#send").css("color", "#fff");
          $(
            "#message-to-send,#txtDestinomail,#txtNommail,#txtMessagemail"
          ).addClass("cambio_place");
          $("#message-to-send").css("border", "none");
          $(
            ".fa-file-image-o,.fa-file-o,.fa-gamepad,.fa-pencil-square-o,.fa-cog,.fa-file-export,.fa-envelope,.fa-share-alt"
          ).css("color", "rgb(225,225,225)");
  ...
  color: #fff;`
      ...
      $(".swal2-popup,.swal2-modal,.swal2-show").css(
        "background",
        "rgb(52, 61, 91)"
      );
  ...
  color: #fff;`
          ...
          $("#message-to-send").css("border", "none");
          $(
            ".fa-file-image-o,.fa-file-o,.fa-gamepad,.fa-smile-o,.fa-pencil-square-o,.fa-cog,.fa-file-export,.fa-envelope,.fa-share-alt"
          ).css("color", "rgb(225,225,225)");
          $(".bi-power").css("color", "white");
          $(".scrolldown").css("background", "#004C99");
          $(".scrolldown").css("color", "white");
...
>>>>>>> 81b81ef78abbdc82a08d52f8c669bda87fb74beb
  ...
  function Resized() {
    ...
    if (
      chatarea.offsetHeight + chatarea.scrollTop + 220 ==
        chatarea.scrollHeight + 2 ||
      chatarea.offsetHeight + chatarea.scrollTop + 220 >= chatarea.scrollHeight
    ) {
      confirmador = true;
    } else {
      confirmador = false;
...
>>>>>>> 81b81ef78abbdc82a08d52f8c669bda87fb74beb
 ...
 $('.swal2-popup,.swal2-modal,.swal2-show,.swal2-title,.swal2-content,.swal2-checkbox').attr('style','color: white !important;');*/
      ...
      const { value: accept } = await Swal.fire({
        ...
        input: "checkbox",
        inputValue: numsonid,
        inputPlaceholder: "Notification sound",
    ...
    socket.on("updateMessages", function (messages, nummessage, sessions) {
      ...
      for (var i = 0; i < messages.length; i++) {
        if (messages[i].sessionId == sessionStorage.roomId) {
          ...
          if (
            messages[i].message ==
            '<strong><i class="fas fa-ban"></i>&nbsp;<em id="deletemess">Se ha eliminado este mensaje</em></strong>'
          ) {
            if (
              messages[i].dibujo != "" &&
              messages[i].dibujo != undefined &&
              messages[i].dibujo != null
            ) {
           ...
           <div class="contenido-message">
            ...
            <div class="message my-message float-left">
              ...
              messages[i].imagen != null &&
              messages[i].imagen != undefined &&
              messages[i].imagen != ""
            ) {
              if (messages[i].username == sessionStorage.username) {
                var nomuser = messages[i].username;
            ...
            <div class="message other-message float-right">
              <a id="mensaje${messages[i].id}" class="message-text-convertido"><img src="${messages[i].dibujo}" id="paintdibujo" width="290px" height="290px"></a>
              <span class="message-data-time float-right space-time" >${messages[i].date}</span>
            </div>
           ...
           <div class="contenido-message">
            ...
            <div class="message other-message float-right">
              <a id="mensaje${messages[i].id}" class="message-text-convertido"><img src="${messages[i].imagen}" id="imagen1" width="290px" height="290px"></a>
              <span class="message-data-time float-right space-time" >${messages[i].date}</span>
            </div>
            <div class="align-delete ${messages[i].id}">
            <button type="button" class="popover1" id="${messages[i].id}" data-container="body" data-toggle="popover" data-placement="top" data-trigger="focus" data-content="Eliminar">   <i class="fas fa-ellipsis-h"></i> </button>
            ...
            <div class="message other-message float-right">
              <a id="mensaje${messages[i].id}" class="message-text-convertido">${messages[i].message}</a>
              <span class="message-data-time float-right space-time">${messages[i].date}</span> 
            </div>
            <div class="align-delete ${messages[i].id}">
            <button type="button" class="popover1" id="${messages[i].id}" data-container="body" data-toggle="popover" data-placement="top" data-trigger="focus" data-content="Eliminar">   <i class="fas fa-ellipsis-h"></i> </button>
      ...
      $(`.message-text-convertido`).each(function(){
        $(this).text($(this).html());
      }
      );
      ...
      $(".message").each(function () {
        if (
          $(this).hasClass("other-message") &&
          !$(this).is(
            ':contains("<em id="deletemess">Se ha eliminado este mensaje</em>")'
          )
        ) {
          $(`.align-delete:eq(${i})`).css(
            "height",
...
>>>>>>> 81b81ef78abbdc82a08d52f8c669bda87fb74beb
            ...
            if ($(".toast")[0]) {
              if (
                !$(".toast")
                  .html()
                  .includes(
                    `<strong>${replaceuser}</strong> se ha unido al chat.`
                  )
              ) {
                Command: toastr["info"](
                  `&nbsp;<strong>${userlast.toUpperCase()}</strong> se ha unido al chat.`
                );
  ...
  function selectedElements(socket) {
    socket.on("searchElement", function (
      data,
      userslist,
      sessions,
      respsesion
...
left: -5px;
  ...
  $("#enviarMail").click(function () {
    if (
      $("#txtDestinomail").val().trim() == "" &&
      $("#txtNommail").val().trim() == "" &&
      $("#txtMessagemail").val().trim() == ""
    ) {
    ...
    setTimeout(function () {
      var url =
        "https://paginacoti.000webhostapp.com/Archivos%20PHP/enviarMail.php";
      var obj1;
      var obj2;
      var obj3;
      var obj4;
      ...
      if (data.sessionId == sessionStorage.roomId) {
        ...
        if (
          ...
          if (data.username == sessionStorage.username) {
            ...
            <div class="message other-message float-right">
              <a id="mensaje${data.id}" class="message-text-convertido"><img src="${data.dibujo}" id="paintdibujo" width="290px" height="290px"></a>
          ...
          if (data.username == sessionStorage.username) {
            ...
            <div class="message other-message float-right">
              <a id="mensaje${data.id}" class="message-text-convertido"><img src="${data.imagen}" id="imagen1" width="290px" height="290px"></a>
              <span class="message-data-time float-right space-time" >${data.date}</span>
            </div>
            <div class="align-delete ${data.id}">
            <button type="button" class="popover1" id="${data.id}" data-container="body" data-toggle="popover" data-placement="top" data-trigger="focus" data-content="Eliminar">   <i class="fas fa-ellipsis-h"></i> </button>
          ...
          if (data.username == sessionStorage.username) {
            ...
            <div class="message other-message float-right">
              <a id="mensaje${data.id}" class="message-text-convertido">${data.message}</a>
              <span class="message-data-time float-right space-time">${data.date}</span> 
            </div>
            <div class="align-delete ${data.id}">
            <button type="button" class="popover1" id="${data.id}" data-container="body" data-toggle="popover" data-placement="top" data-trigger="focus" data-content="Eliminar">   <i class="fas fa-ellipsis-h"></i> </button>
        ...
        $(`.message-text-convertido:last`).text($(`.message-text-convertido:last`).html());
        if ($(".message:last").hasClass("other-message")) {
          $(".align-delete:last").css(
            "height",
            parseInt($(".message:last").height() + 8) + "px"
          );
        }
    ...
    socket.on("exportMessages", function (messages) {
      setTimeout(function () {
        ...
        for (var i = 0; i < messages.length; i++) {
          if (
            messages[i].message != "" &&
            !messages[i].message.includes('<strong><i class="fas fa-ban"></i>')
          ) {
  ...
  $("#quitarlistauser").on("click", function () {
    if ($(window).width() <= 650) {
      if (identuserlistcolor) {
        ...
        $(".people-list").attr(
          "style",
          `width: 12% !important; max-height: 100%;
    word-wrap: break-word;
    overflow-y:auto !important; 
    overflow-x:hidden !important; 
    height: 100% !important;`
        ...
        if (
          ...
          if (!$("#usertyping")[0]) {
            ...
            <div class="message my-message float-left">
              ...
              <span class="message-data-time float-right space-time">${
                data.date
              }</span>
            </div>
